package co.fernandomulato.presentation;

import co.fernandomulato.business.DeliveryService;
import co.fernandomulato.business.ProductService;
...
public class Console {
  ...
  private void handleDeliveryCostOption() {
    ...
    // Leer salto de línea para que pueda pregunta por el código del país.
    // (https://stackoverflow.com/a/13102066/1601530)
    scanner.nextLine();

    System.out.println("Código del país donde se entregará el producto: ");
    String countryCode = scanner.nextLine();

    // Creamos el objeto que será pasado a la capa de dominio para que se haga el
    // cálculo.
